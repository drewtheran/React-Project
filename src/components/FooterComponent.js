        ...
        <footer className="site-footer">
            <div className="container">
                <div className="row">
                    ...
                    <a role="button" className="btn btn-link" href="tel:+12065551234"><i className="fa fa-phone" /> 1-508-735-7708</a><br />
                    <a role="button" className="btn btn-link" href="mailto:notreal@notreal.co"><i className="fa fa-envelope-o" /> coyote@codevenom.co</a>
                    </div>
                </div>
            </div>
        </footer>
